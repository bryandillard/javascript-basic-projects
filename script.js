...
const randomize = document.querySelectorAll('.RandomDiv');

const randomFunc = [heal, attack, heal2, attack2]

randomize.forEach(random => {

if (p2.health > 0 && p1.health && game.isOver == false)
